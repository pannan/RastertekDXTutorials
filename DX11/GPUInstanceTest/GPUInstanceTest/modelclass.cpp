...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	instances[4].position = D3DXVECTOR3(0, 0, 5.0f);

	instances[0].color = D3DXVECTOR3(1,0,0);
	instances[1].color = D3DXVECTOR3(1,1,1);
	instances[2].color = D3DXVECTOR3(0,1,0);
	instances[3].color = D3DXVECTOR3(0,0,1);
	instances[4].color = D3DXVECTOR3(1,1,0);
